...
from habitat import logger, VectorEnv
...
from nav.utils.env_utils import construct_envs
from nav.utils.visualization import generate_video
...
class TransferEvaluator(BaseRLTrainer):
    ...
    def _synchronize_config(self):
        ...
        self.visualize_maps = self.config.GLOBAL_AGENT.visualize_maps
        self.vis_interval = self.config.GLOBAL_AGENT.visualize_interval
    ...
    def _setup_actor_critic_agent(self, cfg) -> None:
    ...
    def eval(self) -> None:
        ...
        while (
            ...
            # if self.visualize_maps and episode_steps[0] % self.vis_interval == 0:
            if self.visualize_maps:
                infos = {

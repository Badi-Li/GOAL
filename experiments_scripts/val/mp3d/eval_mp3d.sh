...
MODEL_PATH=$GOAL_ROOT/pretrained_models/area_potential.pth
...
run_eval() {
    ...
    CUDA_VISIBLE_DEVICES=$device python eval_goal.py \
        ...
        FM.fm_weights '/home/badi/semantic-FM/GOAL/checkpoints/chatgpt_flow.pth' \
